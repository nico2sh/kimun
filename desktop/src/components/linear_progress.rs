// From iced-rs examples: https://github.com/iced-rs/iced/blob/master/examples/loading_spinners/README.md
...
pub const CYCLE_DURATION: f32 = 1.0;

#[allow(missing_debug_implementations)]
pub struct LinearProgress<'a, Theme>
where
    Theme: StyleSheet,
{
    width: Length,
...
impl<'a, Theme> LinearProgress<'a, Theme>
where
    Theme: StyleSheet,
{
...
impl<Theme> Default for LinearProgress<'_, Theme>
where
    Theme: StyleSheet,
{
    fn default() -> Self {
...
impl<'a, Message, Theme, Renderer> Widget<Message, Theme, Renderer> for LinearProgress<'a, Theme>
where
    Message: Clone + 'a,
    Theme: StyleSheet + 'a,
...
impl<'a, Message, Theme, Renderer> From<LinearProgress<'a, Theme>>
...
{
    fn from(linear: LinearProgress<'a, Theme>) -> Self {
        Self::new(linear)
    }
}
